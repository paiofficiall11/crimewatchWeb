...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1362: Object.is,
      _1363: o => o instanceof Array,
      _1364: (a, i) => a.push(i),
      _1368: a => a.pop(),
      _1369: (a, i) => a.splice(i, 1),
      _1370: (a, s) => a.join(s),
      _1371: (a, s, e) => a.slice(s, e),
      _1373: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1374: a => a.length,
      _1376: (a, i) => a[i],
      _1377: (a, i, v) => a[i] = v,
      _1379: o => {
      ...
      _1380: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1382: o => o instanceof Uint8Array,
      _1383: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1384: o => o instanceof Int8Array,
      _1385: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1386: o => o instanceof Uint8ClampedArray,
      _1387: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1388: o => o instanceof Uint16Array,
      _1389: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1390: o => o instanceof Int16Array,
      _1391: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1392: o => o instanceof Uint32Array,
      _1393: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1394: o => o instanceof Int32Array,
      _1395: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1397: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1398: o => o instanceof Float32Array,
      _1399: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1400: o => o instanceof Float64Array,
      _1401: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1402: (t, s) => t.set(s),
      _1403: l => new DataView(new ArrayBuffer(l)),
      _1404: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1406: o => o.buffer,
      _1407: o => o.byteOffset,
      _1408: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1409: (b, o) => new DataView(b, o),
      _1410: (b, o, l) => new DataView(b, o, l),
      _1411: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1412: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1413: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1414: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1415: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1416: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1417: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1418: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1419: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1420: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1421: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1422: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1425: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1426: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1427: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1428: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1429: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1430: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1443: (ms, c) =>
      ...
      _1558: Function.prototype.call.bind(BigInt.prototype.toString),
      _1559: Function.prototype.call.bind(Number.prototype.toString),
      _1560: (d, digits) => d.toFixed(digits),
      _1564: () => globalThis.document,
      _1570: (x0,x1) => { x0.height = x1 },
      _1572: (x0,x1) => { x0.width = x1 },
      _1581: x0 => x0.style,
      _1584: x0 => x0.src,
      _1585: (x0,x1) => { x0.src = x1 },
      _1586: x0 => x0.naturalWidth,
      _1587: x0 => x0.naturalHeight,
      _1603: x0 => x0.status,
      _1604: (x0,x1) => { x0.responseType = x1 },
      _1606: x0 => x0.response,
      _1735: x0 => x0.style,
      _1748: (x0,x1) => { x0.oncancel = x1 },
      _1754: (x0,x1) => { x0.onchange = x1 },
      _1794: (x0,x1) => { x0.onerror = x1 },
      _2212: (x0,x1) => { x0.src = x1 },
      _2664: (x0,x1) => { x0.accept = x1 },
      _2678: x0 => x0.files,
      _2704: (x0,x1) => { x0.multiple = x1 },
      _2722: (x0,x1) => { x0.type = x1 },
      _3440: () => globalThis.window,
      _3502: x0 => x0.navigator,
      _3766: x0 => x0.localStorage,
      _3878: x0 => x0.maxTouchPoints,
      _3888: x0 => x0.platform,
      _3891: x0 => x0.userAgent,
      _3942: x0 => x0.data,
      _3943: x0 => x0.origin,
      _6002: x0 => x0.target,
      _6042: x0 => x0.signal,
      ...
      _6196: x0 => x0.body,
      _6527: (x0,x1) => { x0.id = x1 },
      _7873: x0 => x0.value,
      _7875: x0 => x0.done,
      _8055: x0 => x0.size,
      _8056: x0 => x0.type,
      _8063: x0 => x0.name,
      _8064: x0 => x0.lastModified,
      _8069: x0 => x0.length,
      _8572: x0 => x0.url,
      _8574: x0 => x0.status,
