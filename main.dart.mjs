...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1364: (x0,x1) => x0.replaceChildren(x1),
      _1365: x0 => x0.click(),
      _1377: x0 => x0.decode(),
      ...
      _1789: x0 => x0.style,
      _1802: (x0,x1) => { x0.oncancel = x1 },
      _1808: (x0,x1) => { x0.onchange = x1 },
      ...
      _3932: x0 => x0.maxTouchPoints,
      _3942: x0 => x0.platform,
